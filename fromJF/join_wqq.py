...
histT_E["data"].SetName("mjj4jwqq"+"_1")
histT_M["data"].SetName("mjj4jwqq"+"_2")
histT_E["ttbar_sl_charm"].SetName("mjj4jwqq"+"_3")
histT_M["ttbar_sl_charm"].SetName("mjj4jwqq"+"_4")
histT_E["ttbar_rest"].SetName("mjj4jwqq"+"_5")
histT_M["ttbar_rest"].SetName("mjj4jwqq"+"_6")
histT_E["st"].SetName("mjj4jwqq"+"_7")
histT_M["st"].SetName("mjj4jwqq"+"_8")
histT_E["wjets"].SetName("mjj4jwqq"+"_9")
histT_M["wjets"].SetName("mjj4jwqq"+"_10")
histT_E["zjets"].SetName("mjj4jwqq"+"_11")
histT_M["zjets"].SetName("mjj4jwqq"+"_12")
histT_E["vv"].SetName("mjj4jwqq"+"_13")
histT_M["vv"].SetName("mjj4jwqq"+"_14")
histT_E["higgs"].SetName("mjj4jwqq"+"_15")
histT_M["higgs"].SetName("mjj4jwqq"+"_16")
histT_E["ttbar_sl_light"].SetName("mjj4jwqq"+"_17")
histT_M["ttbar_sl_light"].SetName("mjj4jwqq"+"_18")
histT_E["ttbar_sl_bottom"].SetName("mjj4jwqq"+"_19")
