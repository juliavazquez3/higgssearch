...
for name in histNames:
  ...
  if args.stack:
    ...
    leg.Draw()
    term= "totalHT_"+str(args.type)+"_M_ss"
    if args.ratio: 
      notation = "_ratio_"
      if args.linear:
        notation = "_linratio_"
    ...
    leg.Draw()
    term= "totalHT_"+str(args.type)+"_M_os"
    if args.ratio:
      notation = "_ratio_"
      if args.linear:
        notation = "_linratio_"
    ...
    leg.Draw()
    term= "totalHT_"+str(args.type)+"_E_ss"
    if args.ratio:
      notation = "_ratio_"
      if args.linear:
        notation = "_linratio_"
    ...
    if args.png: c1.Print(plotdir+term+notation+ name + ".png")
    else: c1.SaveAs(plotdir+term+notation + name + ".pdf")
    ...
    leg.Draw()
    term= "totalHT_"+str(args.type)+"_E_os"
    if args.ratio:
      notation = "_ratio_"
      if args.linear:
        notation = "_linratio_"
