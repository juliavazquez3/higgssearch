...
if args.wcs:
   ...
   if "sl" in str(args.channel): samplesHT = samplesHT + ["rttbar_sl_charm_mudhad"]
...
for name in observable_names:
  ...
  if args.wcs: samples = ["ttbar_sl_nocharm","ttbar_sl_charm","ttbar_dl","ttbar_dh","zjets","vv","st_nocharm","st_charm","st_else","wjets", "ttbar_sl_charm_mudhad"]
  ...
  if args.sumEM:
    ...
    for s in samples:
       envHi_btaglight_M[s] = histT_btaglightup_M[s]
       envLo_btaglight_M[s] = histT_btaglightdown_M[s]
       envHi_btagheavy_M[s] = histT_btagheavyup_M[s]
       envLo_btagheavy_M[s] = histT_btagheavydown_M[s]
       envHi_btaglight_E[s] = histT_btaglightup_E[s]
       envLo_btaglight_E[s] = histT_btaglightdown_E[s]
       envHi_btagheavy_E[s] = histT_btagheavyup_E[s]
       envLo_btagheavy_E[s] = histT_btagheavydown_E[s]
  ...
  if args.wcs: samples = ["vv","ttbar_dl","ttbar_dh","zjets","wjets","st_else","st_nocharm","st_charm","ttbar_sl_nocharm","ttbar_sl_charm","ttbar_sl_charm_mudhad"]
  ...
  if args.sumEM:
    ...
    for s in samples:
      if s == "ttbar_sl_charm":
         ...
         mchists_lightup[s] = envHi_btaglight_M[s].Clone("signal_lightUp")
         mchists_lightdown[s] = envLo_btaglight_M[s].Clone("signal_lightDown")
         mchists_heavyup[s] = envHi_btagheavy_M[s].Clone("signal_heavyUp")
         mchists_heavydown[s] = envLo_btagheavy_M[s].Clone("signal_heavyDown")
      else:
         mchists[s] = histT_nom_M[s].Clone(str(s))
         mchists_lightup[s] = envHi_btaglight_M[s].Clone(s+"_lightUp")
         mchists_lightdown[s] = envLo_btaglight_M[s].Clone(s+"_lightDown")
         mchists_heavyup[s] = envHi_btagheavy_M[s].Clone(s+"_heavyUp")
         mchists_heavydown[s] = envLo_btagheavy_M[s].Clone(s+"_heavyDown")

    print("Integral of M data is "+str(data_obs.Integral()))
    for s in samples:
      print("Integral of "+str(s)+" MC process for M channel is "+str(mchists[s].Integral()))
    ...
    for s in samples:
      if s == "ttbar_sl_charm":
         ...
         mchists_lightup[s] = envHi_btaglight_E[s].Clone("signal_lightUp")
         mchists_lightdown[s] = envLo_btaglight_E[s].Clone("signal_lightDown")
         mchists_heavyup[s] = envHi_btagheavy_E[s].Clone("signal_heavyUp")
         mchists_heavydown[s] = envLo_btagheavy_E[s].Clone("signal_heavyDown")
      else:
         mchists[s] = histT_nom_E[s].Clone(str(s))
         mchists_lightup[s] = envHi_btaglight_E[s].Clone(s+"_lightUp")
         mchists_lightdown[s] = envLo_btaglight_E[s].Clone(s+"_lightDown")
         mchists_heavyup[s] = envHi_btagheavy_E[s].Clone(s+"_heavyUp")
         mchists_heavydown[s] = envLo_btagheavy_E[s].Clone(s+"_heavyDown")

    print("Integral of E data is "+str(data_obs.Integral()))
    for s in samples:
      print("Integral of "+str(s)+" MC process for E channel is "+str(mchists[s].Integral()))
