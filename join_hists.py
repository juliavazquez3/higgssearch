...
if args.type == "sl":
  filePath = "/nfs/cms/vazqueze/hists_ttbar/hists/higgs/"
  term = "histstt_SL_v1v2vBWP"
else:
  filePath = "/nfs/cms/vazqueze/hists_ttbar/hists/higgs/sv/"
  term = "histstt_SV_v1v2vBWP"
...
for data_op in datayears:
	...
	histFile[data_op] = {}
	for s in samplesHT:
		if isfile(filePath + term+"_"+s+data_op+".root"):
...
histT_E_ss["ttbar_sl"].SetName("mjj4j"+str(args.type)+"ss_3")
histT_M_ss["ttbar_sl"].SetName("mjj4j"+str(args.type)+"ss_4")
...
histT_E_os["ttbar_sl"].SetName("mjj4j"+str(args.type)+"os_3")
histT_M_os["ttbar_sl"].SetName("mjj4j"+str(args.type)+"os_4")
...
samplesF = ["data","ttbar_sl","ttbar_rest","st","wjets","zjets","vv","higgs"]
 
if args.type == "sl":
  path_ss = "/nfs/cms/vazqueze/hists_ttbar/hists/higgs/hm"+str(args.higgsmass)+"/mjj4jslss.root"
  path_os = "/nfs/cms/vazqueze/hists_ttbar/hists/higgs/hm"+str(args.higgsmass)+"/mjj4jslos.root"
else:
  path_ss = "/nfs/cms/vazqueze/hists_ttbar/hists/higgs/hm"+str(args.higgsmass)+"/mjj4jsvss.root"
  path_os = "/nfs/cms/vazqueze/hists_ttbar/hists/higgs/hm"+str(args.higgsmass)+"/mjj4jsvos.root"
